...
namespace DataAccess.EFCore.Migrations
{
    ...
    [Migration("20230823101432_addTablesBrouillon")]
    partial class addTablesBrouillon
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.PartieBR", b =>
                {
                    b.Property<long>("PartieBRId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("PartieBRId"));
                    ...
                    b.Property<DateTime?>("SeanceDebut")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("SeanceFin")
                        .HasColumnType("datetime2");

                    b.Property<string>("SeanceLibelle")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PartieBR", (string)null);

                    b.HasDiscriminator<string>("Discriminator").HasValue("PartieBR");
            ...
            modelBuilder.Entity("Domain.Entities.CampagneBR", b =>
                {
                    b.HasBaseType("Domain.Entities.PartieBR");
                    ...
                    b.HasDiscriminator().HasValue("CampagneBR");
                });

            modelBuilder.Entity("Domain.Entities.OneshotBR", b =>
                {
                    b.HasBaseType("Domain.Entities.PartieBR");
                    ...
                    b.HasDiscriminator().HasValue("OneshotBR");
                });
